...
Dabei ist $\sigma = \SI{5.7*10^{-12}}{\watt\per\centimetre\tothe{2}\per\kelvin\tothe{4}}$ die Sefan-Boltzmannsche Strahlungskonstante, f die emittierende Kathodenoberfläche und $\eta=0.28$ der Emissionsgrad der Oberfäche.