...
fifteen, thirty, sixty = np.genfromtxt('data_scripts/tiny.txt', unpack = True)
...
np.savetxt('data_scripts/tiny_velocity.txt', np.column_stack([fifteen, flowvelocity15, thirty, flowvelocity30, sixty ,flowvelocity60]), fmt = '%.3f')
