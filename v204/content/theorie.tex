...
\begin{equation}
    T(x,t)=T_{max} \exp \left({-\sqrt{\frac{w \rho c}{2 \kappa}}} x \right)\cos \left( wt-\sqrt{\frac{w \rho c}{2 \kappa}}\, x\right)\, ,
\end{equation}
...
\end{equation}
Das Amplitudenverhältnis $A_{nah}$ zu $A_{fern}$ der Welle an zwei Messstellen $x_{nah}$ und $x_{fern}$, ergibt die Dämpfung der Welle.
