...
xr, xl, Dr, Dl = np.genfromtxt('data_scripts/probe3double.txt', unpack = True)
...
print(f'der Paremter b von der Probe3 rechts ist = {params1[1]} pm {errors1[1]}')
print(f'der Paremter m von der Probe3 links  ist = {params2[0]} pm {errors2[0]}')
print(f'der Paremter b von der Probe3 links  ist = {params2[1]} pm {errors2[1]}')
plt.tight_layout(pad=0, h_pad=1.08, w_pad=1.08)
plt.savefig('build/probe3double.pdf')