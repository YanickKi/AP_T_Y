...
x, D = np.genfromtxt('data_scripts/probe3single.txt', unpack = True)
...
print(f'der Paremter m von der Probe3 ist = {params[0]} pm {errors[0]}')
print(f'der Paremter b von der Probe3 ist = {params[1]} pm {errors[1]}')


plt.tight_layout(pad=0, h_pad=1.08, w_pad=1.08)
plt.savefig('build/probe3single.pdf')