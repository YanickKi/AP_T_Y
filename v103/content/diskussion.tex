...
\begin{table}
    ...
    \end{tabular}
\end{table}
In der Tabelle \ref{tab:zweilit} sind die Abweichungen bei beidseitiger Einspannung zu den Literaturwerten\cite{lit} von den vermuteten Materialen aufgeführt
\begin{table}
    \centering
