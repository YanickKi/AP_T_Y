...
\end{equation}
Die Kondensatorspannungsamplitude lässt sich in Abhängigkeit von $\varphi$ darstellen mit 
\begin{equation}
    \label{eqn:aphi}
...
und weiteren vereinfachungen die Amplitude $A(\omega)$ ohne $\varphi$-Abhängigkeit darstellen als
\begin{equation}
    \label{eqn:ampli}
