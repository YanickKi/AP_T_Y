...
plt.plot(x, params1[0] * x**2 + params1[1] * x + params1[2], label = 'Ausgleichsgerade für $T_1$')
plt.plot(x, params2[0] * x**2 + params2[1] * x + params2[2], label = 'Ausgleichsgerade für $T_2$')
